...
export class BorderDrawer {
	...
	private DrawTileOverlay(direction: Side) {
		...
		this.Camera.Draw(sprite, blockLayer + layerAdjustment, finalPosition, null, 0, 0, null, this.BlockContext.CurrentAlpha, true)
	}
	...
	private DrawWallOverlaysFor(otherType: BlockType, side: Side) {
		...
		if (this.BlockContext.BlockType === BlockType.Full && (otherType === BlockType.Empty || otherType === BlockType.Floor))
			this.Camera.Draw(this.FullWallOverlayFor(side), Layer.Middle + Layer.OverlayWestAdjustment, center, null, 0, 0, null, this.BlockContext.CurrentAlpha, true)
		else if (this.BlockContext.BlockType === BlockType.Full && otherType === BlockType.Half)
			this.Camera.Draw(this.HalfWallOverlayFor(side), Layer.Middle + Layer.OverlayWestAdjustment, center.addFrom(Camera.HalfHeight), null, 0, 0, null, this.BlockContext.CurrentAlpha, true)
		else if (this.BlockContext.BlockType === BlockType.Half && (otherType === BlockType.Empty || otherType === BlockType.Floor))
			this.Camera.Draw(this.HalfWallOverlayFor(side), Layer.Middle + Layer.OverlayWestAdjustment, center, null, 0, 0, null, this.BlockContext.CurrentAlpha, true)
	}
