import { CalendarEvent, MessageThread, Person, TopScoreSet } from "@lundin/api-interfaces"
...
export class StorageService {
	...
	minestrygerTopScoreCollection = new Collection<TopScoreSet & { _id: number }>("minestryger-topscores", this)
